...
{
    public partial class seeds7 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProfileMessages_AspNetUsers_FromUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ForumThreads_AspNetUsers_PostedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ForumReplies_PostedById",
                table: "ForumReplies",
                column: "PostedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ForumThreads_IsDeleted",
                table: "ForumThreads",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_ForumThreads_PostedById",
                table: "ForumThreads",
                column: "PostedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfileMessages_IsDeleted",
                table: "ProfileMessages",
                column: "IsDeleted");
